...
return [
    ...
    */
    ...
    'between'              => [
        ...
        // 'string'  => 'Допускается от :min до :max символов.',
        'array'   => 'Количество элементов в поле :attribute должно быть между :min и :max.',
    ],
    
    'boolean'              => 'Поле :attribute должно иметь значение логического типа.',
    'confirmed'            => 'Поля не совпадают: :attribute.',
    ...
    'email'                => ':attribute уже зарегистрирован.',
    'exists'               => 'Указанный(-ая) :attribute не найден.',
    ...
    'regex'                => 'Не верный формат: :attribute.',
    ...
    'rules_incorrect'      => 'Validation rules are incorrect.',
    'rule_not_permitted'   => 'Validation rule :rule not permitted.',

    'bot' => [
        'input_name_not_found'  => 'Input name :name not found',
        'form_in_use'           => 'Form is used in Listener ":listener_text"',
    ],
    
    'active'  => [
        'available' => 'Невозможно включить выбранный авточат. В данный момент у Вас активно :active из :available доступных Вам.'
    ],
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'custom' => [
        ...
        'slug' => [
            'unique' => 'Страница уже занята'
        ],
        'data.email' => [
            'email' => 'Email имеет ошибочный формат'
        ]
    ],
